...
print(u'日期',u'资金',u'持仓',u'总资产',u'资金变化',u'持仓变化',u'持仓价值变化',u'总资产当日变化',sep=',',file=DayFile)
LogFileName = filename.split('.')[0]+"_All_Detail.dat"
...
for i in range(19, len(HistoryDayPX)):      #每天情况。前19天没有20日平均，所以从第20天开始
    ...
    DayProfit = calc_profit(TotalMoney, TotalPos, LastPX, TodayMoney, TodayPos, HistoryDayPX[i][2])
